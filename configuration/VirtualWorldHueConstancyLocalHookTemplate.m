% VirtualWorldHueConstancyLocalHook
%
% Set up machine specific prefs for the VirtualWorldHueConstancy project.
%
...
% called output/VirtualWorldHueConstancy of what is returned by
...
dataDirName = 'VirtualWorldHueConstancy';
